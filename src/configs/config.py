...
TRY_TIMES = _CIRCULATE_CONFIG.get("circulate", "try_times")
OCR_THRESHOLD = _CIRCULATE_CONFIG.get("circulate", "ocr_threshold")
WAIT_TIME = _CIRCULATE_CONFIG.get("circulate", "wait_time")